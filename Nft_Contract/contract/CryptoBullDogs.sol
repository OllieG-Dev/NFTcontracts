...
contract CryptoBullDogs is ERC721Enumerable, Ownable
{
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        if(bytes(base).length > 0){
             return reveal ? string(abi.encodePacked(base, tokenId.toString(), ".json")) : string(abi.encodePacked("https://gateway.pinata.cloud/ipfs/QmYseREz6tjXicHEMcyVQeiocsrrzzqv6qKLwzcAGWQMLP"));
        }
        else            
        return "";
    }
