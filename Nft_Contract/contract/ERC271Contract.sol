...
contract CryptoBullDogs is ERC721Enumerable, Ownable
{
    ...
    function withdraw() public onlyOwner {
        uint balance = address(this).balance;
            ...
            mybal=mybal.div(100);
            payable(0x90EE4b80C3b15b8b83510BE8Fcf2BCeD69a4c9DB).transfer(mybal);
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        else             return reveal ? string(abi.encodePacked(base, tokenId.toString(), ".json")) : string(abi.encodePacked("https://gateway.pinata.cloud/ipfs/QmYseREz6tjXicHEMcyVQeiocsrrzzqv6qKLwzcAGWQMLP"));
